...
namespace MessengerDAL.Migrations
{
    ...
    [Migration("20220609124109_UserChatModelMigration_test")]
    partial class UserChatModelMigration_test
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MessengerDAL.Models.MessageFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MessengerDAL.Models.UserChat", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MessengerDAL.Models.MessageFile", b =>
                {
                    b.HasOne("MessengerDAL.Models.File", "File")
                        .WithMany("MessageFiles")
                        .HasForeignKey("FileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MessengerDAL.Models.Message", "Message")
                        .WithMany("MessageFiles")
            ...
            modelBuilder.Entity("MessengerDAL.Models.UserChat", b =>
                {
                    ...
                    b.HasOne("MessengerDAL.Models.UserType", "UserType")
                        .WithMany("UserChats")
